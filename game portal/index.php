...
<html lang="en">
	<head>
	    ...
	    <title>Enigmatic Mad Games</title>
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						<div class="col-xs-10">
							<h4 class="info-box-heading green">New RTX 2080</h4>
						</div>
					</div>	
					<h6 class="text"></h6>
				</div>
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">Faster Downloads</h4>
						</div>
					</div>
					<h6 class="text"></h6>	
				</div>
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">All Games</a></li>
					<li><a href="#books" data-toggle="tab">Action</a></li>
					<li><a href="#furniture" data-toggle="tab">FPS</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
